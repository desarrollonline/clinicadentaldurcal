...
<div class="image-w relative<?php echo esc_attr($image_w_class);?>">
		...
		<?php elseif ($onclick == 'lightbox') : ?>
			...
			?>
			<a rel="orion-images" class="<?php echo esc_attr($image_class);?>" href="<?php echo wp_kses_post($large_image[0]);?>" title="<?php echo esc_attr($image_alt);?>" data-caption="<?php echo esc_attr($image_alt);?>">
		<?php else : ?>
