...
function orion_new_theme_notification() {
    ...
    <div class="notice notice-alert is-dismissible">
        <p><?php echo wp_kses_post( '<strong>Update notice:</strong> New Dentalia 2.1 theme version is available. Download it from <a target="_blank" rel="noopener noreferrer" href="https://themeforest.net/downloads">ThemeForest</a> or use Envato market plugin to upgrade to latest version.', 'dentalia' ); ?></p>
    </div>
    <?php
}
...
if (version_compare($theme_version, "2.1") == "-1") {
...
function orion_welcome_new_user() {
    ...
    <div class="notice notice-success is-dismissible">
        <p><?php echo wp_kses_post( '<strong>Welcome to Dentalia!</strong><br>
          Visit <a href="' . get_admin_url() . 'admin.php?page=orion-theme-options">Theme Options</a>, where you can import the Demo Content and start customizing your website.'); ?>
        </p>
    </div>
    <?php
}
