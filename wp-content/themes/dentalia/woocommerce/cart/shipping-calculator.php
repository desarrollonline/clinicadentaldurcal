...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php printf( '<a href="#" class="shipping-calculator-button btn-md btn btn-black btn-empty">%s <i class="orionicon orionicon-truck"></i></a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
	...
	<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_state', true ) ) : ?>
		...
		<p class="text-left"><button type="submit" name="calc_shipping" value="1" class="btn-flat btn-c1 btn btn-md btn-update-shipping"><?php _e( 'Update', 'woocommerce' ); ?></button></p>
