...
<div class="orion-cart-wrapper minicart-hidden">
						...
						<li class="<?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
							...
							<?php else : ?>
								<a class="item-link font-2" href="<?php echo esc_url( $product_permalink ); ?>">
									<?php echo $thumbnail . '<span class="item-title product-title">'.$product_name . '</span>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
								</a>
							<?php endif; ?>
	...
	<?php if ( ! WC()->cart->is_empty() ) : ?>
		...
		<div class="cart-total text-uppercase clearfix item-title font-3">
		<?php
		/**
